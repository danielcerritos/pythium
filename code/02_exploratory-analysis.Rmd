...
```{r agg soybean distributions}
# distributions
seed_soybean %>% 
  ggplot(aes(y = germination_10)) +
  geom_histogram()
...
seed_soybean %>% 
  ggplot(aes(y = colonized_10)) +
  geom_histogram() 

seed_soybean %>% 
  ggplot(aes(y = rotted_5)) +
  geom_histogram() 
# skew distributions in all variables
```
...
seed_soybean %>% 
  ggplot(aes(x = species, y = germination_10)) +
  geom_boxplot() + 
  geom_jitter (alpha = 0.2) +
  coord_flip()

seed_soybean %>% 
  ggplot(aes(x = species, y = colonized_5)) +
  geom_boxplot() + 
  geom_jitter (alpha = 0.2) +
  coord_flip()

seed_soybean %>% 
  ggplot(aes(x = species, y = colonized_10)) +
  geom_boxplot() + 
  geom_jitter (alpha = 0.2) +
  coord_flip()

seed_soybean %>% 
  ggplot(aes(x = species, y = rotted_5)) +
  geom_boxplot() + 
  geom_jitter (alpha = 0.2) +
...
seed_corn %>%
  ggplot(aes(x = species, y = germination_5)) +
  geom_boxplot() + 
  geom_jitter (alpha = 0.2) +
  coord_flip()
...
seed_corn %>% 
  mutate(dry_weight_g = dry_weight_bag_g - bag_weight_g) %>%   
  ggplot(aes(x = species, y = dry_weight_g)) +
  geom_boxplot() + 
  geom_jitter (alpha = 0.2) +
  coord_flip()
...
seedling_soybean_agar %>% 
  ggplot(aes(x = species, y = emergence)) +
  geom_col() +
  coord_flip() 
  
seedling_soybean_agar %>%
  ggplot(aes(x = species, y = plant_mass_g)) +
  geom_boxplot() + 
  geom_jitter (alpha = 0.2) +
  coord_flip()

seedling_soybean_agar %>%
  ggplot(aes(x = species, y = root_mass_g)) +
  geom_boxplot() + 
  geom_jitter (alpha = 0.2) +
  coord_flip()
```

...
prueba <- right_join(correct_ids, isolates_used, by = "isolate_id") %>% 
  arrange(plate_id)
```
...
prueba_2 <- right_join(add_names, seed_soybean_isolates, by = "plate_id")
prueba_2$plate_id <- as.character(prueba_2$plate_id)

# all data
seed_soybean_clean <- bind_rows(seed_soybean_controls, prueba_2)
...
prueba_3 <- right_join(add_names, seed_corn_isolates, by = "plate_id")
...
# combine both
prueba_3$plate_id <- as.character(prueba_3$plate_id)
seed_corn_clean <- bind_rows(seed_corn_controls, prueba_3)
